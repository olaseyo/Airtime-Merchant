            ...
            <div class="row ks-widgets-collection">
                ...
                <div class="col-lg-3">
                    <div class="ks-dashboard-widget ks-widget-amount-statistics ks-info">
                        <div class="ks-statistics">
                            <span class="ks-amount" data-count-up="3119">{{ $total_card }}</span>
                            <span class="ks-text">Total Purchase</span>
                        </div>
                        <div class="ks-percent ks-down"><span class="ks-text">100%</span></div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="ks-dashboard-widget ks-widget-amount-statistics ks-success">
                        <div class="ks-statistics">
                            <span class="ks-amount" data-count-up="8201">{{ $used }}</span>
                            <span class="ks-text">Total Used</span>
                        </div>
                        <div class="ks-percent ks-up"><span class="ks-text">{{ $used_percent }}%</span></div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="ks-dashboard-widget ks-widget-amount-chart-statistics ks-purple">
                        <div class="ks-body">
                            <div class="ks-statistics">
							  <span class="ks-amount" data-count-up="8201">{{ $unused }}</span>
                                <span class="ks-text">Total Unused</span>
                                <span class="ks-amount">{{ $unused_percent }}%</span>
                            </div>
                            <div class="ks-chart">
                ...
                <div class="col-lg-3">
                    <div class="ks-dashboard-widget ks-widget-amount-chart-statistics ks-white">
                        <div class="ks-body">
                            <div class="ks-statistics">
                                <span class="ks-text">Total Spent</span>
                                <span class="ks-amount">&#x20A6 {{ $total_spent }}</span>
                            </div>
                            <div class="ks-chart">
